        ...
        {filteredNotifications.map((item) => {
          ...
          return (
            <div
              ...
              className={`relative bg-white dark:bg-slate-900 rounded-2xl p-5 border transition-all cursor-pointer shadow-sm ${
                isUnread
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-3 pt-2.5 border-t border-slate-100 dark:border-slate-800/80 text-[11px] text-slate-400">
                    ...
                    {isUnread && (
                      <span className="text-indigo-600 dark:text-indigo-400 font-bold text-[10px] flex items-center gap-1">
