        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:40px 40px 0;">
              ...
              <p style="margin:0 0 28px;font-size:15px;line-height:1.7;color:#475569;">Your Smart Library student account has been <strong>successfully created</strong> by the library administrator. You can now log in using your registered email address and your initial password.</p>
                ...
                <tr>
                  <td style="padding:20px 24px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:16px;">
                      ...
                      <tr><td style="padding:10px 0;border-bottom:1px solid #e2e8f0;"><span style="font-size:12px;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:0.5px;">Seat Number</span><p style="margin:4px 0 0;font-size:15px;font-weight:700;color:#1e293b;">${student.assignedSeatNumber ? 'Seat ' + student.assignedSeatNumber : 'General Access (Unassigned)'}</p></td></tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                <tr>
                  <td style="background-color:#fefce8;border:1px solid #fde68a;border-radius:10px;padding:16px 20px;">
                    ...
                    <p style="margin:0 0 6px;font-size:13px;color:#78350f;line-height:1.6;">Your account credentials are private. Please do not share your password with anyone.</p>
                    <p style="margin:0 0 6px;font-size:13px;font-weight:700;color:#78350f;line-height:1.6;">Your initial password is your registered mobile number.</p>
                    <p style="margin:0;font-size:13px;color:#78350f;line-height:1.6;">After logging in, please change your password to protect your account.</p>
                  </td>
                </tr>
              </table>
              <p style="margin:0 0 8px;font-size:15px;line-height:1.7;color:#475569;">We are happy to have you as a member of <strong>Lakshya Smart Library</strong>.</p>
              <p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:#475569;">The system lets you:</p>
              <ul style="margin:0 0 28px;padding-left:22px;font-size:14px;line-height:1.8;color:#475569;">
                <li>track your attendance</li>
                <li>manage seat entry/exit via QR codes</li>
                <li>view your library activity</li>
                <li>raise support tickets/complaints</li>
              </ul>
