...
const StudentProfileSchema = new mongoose_1.Schema({
    ...
    activeMembershipId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Membership' },
    currentSeatId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Seat' },
    isCurrentlyInside: { type: Boolean, default: false, index: true },
    lastEntryTime: { type: Date },
    lastExitTime: { type: Date },
}, { timestamps: true });
StudentProfileSchema.index({ libraryId: 1, studentIdNumber: 1 });
